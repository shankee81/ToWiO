...
feature %q{
  ...
  context "as a site administrator" do
    ...
    scenario "listing relationships" do
      ...
      create(:enterprise_relationship, parent: e2, child: e3, permissions_list: [:create_tagged_variants])
      create(:enterprise_relationship, parent: e3, child: e4, permissions_list: [:manage_products])
      create(:enterprise_relationship, parent: e4, child: e1, permissions_list: [:add_to_order_cycle, :create_tagged_variants, :manage_products])
